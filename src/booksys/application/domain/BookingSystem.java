...
public class BookingSystem
{
  ...
  {
    Enumeration<?> like = observers.elements() ;
    while (like.hasMoreElements()) {
      BookingObserver bo = (BookingObserver) like.nextElement() ;
      bo.update() ;
    }
  }
  ...
  {
    selectedBooking = null ;
    Enumeration<?> book = currentBookings.elements() ;
    while (book.hasMoreElements()) {
      Booking b = (Booking) book.nextElement() ;
  ...
  private boolean doubleBooked(Time startTime, int tno, Booking ignore)
  {
    ...
    Enumeration<?> booking = currentBookings.elements() ;
    while (!doubleBooked && booking.hasMoreElements()) {
      Booking b = (Booking) booking.nextElement() ;
